...
class ProxiesPage(QtWidgets.QWidget):
    ...
    def setupUi(self, proxiespage):
        ...
        font = QtGui.QFont()
        font.setPointSize(13) if platform.system() == "Darwin" else font.setPointSize(13)
        ...
        self.listname_edit.setStyleSheet("outline: 0;border: 1px solid #60a8ce;border-width: 0 0 2px;color: rgb(234, 239, 239);")
        ...
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(18) if platform.system() == "Darwin" else font.setPointSize(18)
        font.setWeight(50)
        ...
        self.loadlist_box.setStyleSheet("outline: 0;border: 1px solid #60a8ce;border-width: 0 0 2px;color: rgb(234, 239, 239);")
        ...
        self.saveproxies_btn.setStyleSheet("color: #FFFFFF;background-color: #60a8ce;border-radius: 10px;border: 1px solid #2e2d2d;")
        ...
        self.deleteproxies_btn.setStyleSheet("color: #FFFFFF;background-color: #60a8ce;border-radius: 10px;border: 1px solid #2e2d2d;")
        ...
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(22) if platform.system() == "Darwin" else font.setPointSize(22)
        font.setWeight(50)
