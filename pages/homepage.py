...
class HomePage(QtWidgets.QWidget):
    ...
    def setupUi(self, homepage):
        ...
        font.setPointSize(15) if platform.system() == "Darwin" else font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        ...
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(22) if platform.system() == "Darwin" else font.setPointSize(18)
        font.setBold(False)
        font.setWeight(50)
        ...
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16) if platform.system() == "Darwin" else font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
...
class TaskTab(QtWidgets.QWidget):
    ...
    def setupUi(self,TaskTab):
        ...
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(13) if platform.system() == "Darwin" else font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
